...
export type FeedItem =
  | ({ type: 'announcement'; id: string; title: string; body: string; imageUrl?: string; timestamp: string; author: string; authorPhotoUrl?: string; /** Set when the API only surfaced this announcement because the viewer is an admin: it was aimed at a different audience. */ visibleAsAdmin?: boolean } & FeedInteractions)
