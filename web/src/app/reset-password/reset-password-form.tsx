...
/**
 * The reset form. Only rendered once the server component has confirmed the
 * token is live (see page.tsx), so the form never has to reason about a
 * missing or dead token itself.
 */
